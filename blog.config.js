...
const BLOG = {
  ...
  UUID_REDIRECT: process.env.NEXT_PUBLIC_UUID_REDIRECT === 'true' || false, // 是否根据 redirect.json 将 Notion UUID 路径重定向到 slug
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'qisc0stni6', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
